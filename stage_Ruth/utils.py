...
def apply_response_correction(st, inv, pre_filt=(0.05, 0.1, 100, 120)):
    """
...
def plot_signal(trace, save=False, save_path=None):
...
def process_and_plot(
    ...
    # Remove response
    st = apply_response_correction(st, inv, pre_filt)
    ...
    for tr in st:
        ...
        plot_signal(tr, save=save_figures, save_path=save_path)
