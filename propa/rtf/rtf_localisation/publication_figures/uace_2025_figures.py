...
@Desc    :   Create figures for UACE 2025 proceedings
"""
...
if __name__ == "__main__":
    ...
    root_backup = r"C:\Users\baptiste.menetrier\Desktop\devPy\phd\propa\rtf\rtf_localisation\uace_testcase\data\backups"

    data_name = "uace_backup_22052025_realenv_1km_5ships"
    root_data = os.path.join(root_backup, data_name, "data")

    p1 = np.arange(-10, 16, 1)
    p2 = np.arange(-5, 5, 1)
    p3 = np.arange(5, 15, 1)
    p4 = np.arange(-5, 15, 1)
    p5 = np.arange(-10, 1, 1)
